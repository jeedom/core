...
?>
<a class="btn btn-danger pull-right" id="bt_logdisplayremoveLog"><i class="fas fa-trash-o"></i> {{Supprimer}}</a>
<a class="btn btn-warning pull-right" id="bt_logdisplayclearLog"><i class="fas fa-times"></i> {{Vider}}</a>
<a class="btn btn-success pull-right" id="bt_logdisplaydownloadLog"><i class="fas fa-cloud-download"></i> {{Télécharger}}</a>
