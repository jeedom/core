...
<div class="input-group pull-right" style="display:inline-flex">
	<span class="input-group-btn">
		...
		</a><a class="btn btn-success btn-sm roundedRight" id="bt_cmdConfigureSave"><i class="far fa-check-circle"></i> {{Enregistrer}}</a>
	</span>
</div>
<div role="tabpanel">
				...
				<form class="form-horizontal">
					<fieldset>
						...
						<div class="form-group">
							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
								<input type="password" class="cmdAttr form-control" data-l1key="configuration" data-l2key="actionCodeAccess" autocomplete="new-password" disabled/>
							</div>
						</div>
					</fieldset>
				</form>
