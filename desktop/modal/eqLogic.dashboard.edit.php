...
<div id="div_displayEqLogicConfigure">
  <div class="input-group pull-right" style="display:inline-flex">
    <span class="input-group-btn">
      <!--<a id="bt_eqLogicConfigCancel" class="btn btn-success btn-sm roundedLeft"><i class="fas fa-window-close"></i> {{Annuler}}
...
$('#bt_eqLogicConfigCancel').off().on('click', function(event) {
