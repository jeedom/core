	...
	<tbody>
		...
		foreach (cmd::all() as $cmd) {
			...
			if ($cmd->getIsHistorized() == 1) {
				...
				echo '<input type="color" class="graphDataOption form-control input-sm" data-l1key="configuration" data-l2key="graphColor" style="width : 110px;" />';
				echo '</div> ';
				echo '<div class="form-group">';
				echo ' <select class="graphDataOption form-control input-sm" data-l1key="configuration" data-l2key="graphType" style="width : 70px;">';
				...
				echo '</div> ';
				echo '<div class="form-group">';
				echo ' <select class="graphDataOption form-control input-sm" data-l1key="configuration" data-l2key="groupingType" style="width : 140px;">';
				...
				echo '<label>{{Echelle}} :</label> <select class="graphDataOption form-control input-sm" data-l1key="configuration" data-l2key="graphScale" style="width : 80px;">';
