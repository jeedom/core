...
foreach (cmd::all() as $cmd) {
	...
	if ($eqLogic->getIsVisible() == 1 && $cmd->getIsHistorized() == 1) {
		...
		echo '<label>Couleur :</label> <select class="graphDataOption form-control input-sm" data-l1key="configuration" data-l2key="graphColor" style="width : 110px;background-color:#4572A7;color:white;">';
