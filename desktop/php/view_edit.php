		...
		<legend style="height: 35px;">
			...
			<div class="input-group pull-right" style="display:inline-flex">
				<span class="input-group-btn">
					<a class="btn btn-default btn-xs roundedLeft" id="bt_editView"><i class="fas fa-pencil-alt"></i> {{Configuration}}</a><a class="btn btn-default btn-xs" id="bt_addviewZone"><i class="fas fa-plus-circle"></i> {{Ajouter une zone}}</a><a class="btn btn-primary btn-xs" id="bt_viewResult"><i class="fas fa fa-eye"></i> {{Voir le résultat}}</a><a class="btn btn-success btn-xs" id="bt_saveView"><i class="far fa-check-circle"></i> {{Enregistrer}}</a><a class="btn btn-danger btn-xs roundedRight" id="bt_removeView"><i class="fas fa-minus-circle"></i> {{Supprimer}}</a>
				</span>
			</div>
		</legend>
