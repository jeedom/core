...
$sysCmdsSudo = array(
  ...
  array("cmd" => 'echo "DEBIAN_FRONTEND=noninteractive apt-get -f install -y -o Dpkg::Options::=\'--force-confdef\' -o Dpkg::Options::=\'--force-confold\'" | sudo at now', "name" => 'Fix install'),
  array("cmd" => 'echo "sudo DEBIAN_FRONTEND=noninteractive dpkg --configure -a --force-confdef --force-confold" | sudo at now', "name" => 'Dpkg configure'),
