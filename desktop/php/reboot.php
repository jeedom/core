	...
	function page_rebootjs(rebooti){
		...
		if(rebooti=='1'){
			...
			if(testjeedom > '15'){
				...
				$('#div_reboot_jeedom_texte').empty().html('<h6>Votre Jeedom n\'a pas encore redémarré;, nous continuons cependant à tester son retour.<br />n\'hésitez pas à la débrancher électriquement, puis la rebrancher.</h6>');
			}
		}
	}
