...
<div id="md_specifyUpdate">
   <form class="form-horizontal">
    <fieldset>
        <div class="alert alert-danger">{{Avant toute mise à jour merci de consulter la note de version du core de Jeedom}} <a target="_blank" href="https://github.com/jeedom/core/blob/master/doc/fr_FR/noteVersion.asciidoc">{{ici}}<a></div>
