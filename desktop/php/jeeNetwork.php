...
?>
<div class="alert alert-danger">{{Attention le mode esclave va être retiré de jeedom. Il ne faut SURTOUT PAS en creer de nouveau. Voici ici : }}<a href="https://www.jeedom.com/blog/?p=3408">https://www.jeedom.com/blog/?p=3408</a></div>
                    ...
                    <div class="row">
                        <div class="col-xs-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-8">
                                    <input type="checkbox Escalier"  class="configKey" data-l1key="market::allowDNS" />
                                </div>
                            </div>
                            ...
                            <div class="form-group has-error">
                                ...
                                <div class="col-xs-8">
                                    <input type="checkbox Escalier"  class="configKey" data-l1key="market::redirectSSH" />
                                </div>
                            </div>
