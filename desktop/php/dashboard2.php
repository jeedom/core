...
include_file('3rdparty', 'lodash/lodash.min', 'js');
include_file('3rdparty', 'jquery.gridstack/gridstack.min', 'js');
include_file('3rdparty', 'jquery.gridstack/gridstack.jQueryUI.min', 'js');
include_file('3rdparty', 'jquery.gridstack/gridstack.min', 'css');
...
<?php include_file('desktop', 'dashboard2', 'js');?>
<div class="row" >
	<?php
if (init('object_id') != '') {
