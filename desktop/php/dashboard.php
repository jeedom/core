...
<div style="position : fixed;height:100%;width:30px;top:40px;left:0px;z-index:9998" id="bt_displayObject"></div>
<div style="position : fixed;height:100%;width:30px;top:40px;right:0px;z-index:9998" id="bt_displayScenario"></div>
...
<?php
if ($_SESSION['user']->getOptions('displayScenarioByDefault') == 1) {
	echo '<div class="col-lg-2 col-md-2 col-sm-3" id="div_displayScenario" style="z-index:9999">';
} else {
	echo '<div class="col-lg-2 col-md-2 col-sm-3" id="div_displayScenario" style="display:none;z-index:9999">';
}
?>
