...
<div id="dashTopBar" class="input-group">
	...
	<?php } else { ?>
		<a id="bt_backPreview" href="index.php?v=d&p=preview" class="btn roundedLeft" title="{{Retour Aperçu}}"><i class="fas fa-arrow-circle-left"></i>&nbsp;<i class="fab fa-hubspot"></i></a>
	<?php } ?>
	</div>
