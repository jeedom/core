    ...
    <div class="col-md-3 col-sm-4" id="sd_filterList" style="z-index:999;display:none;">
        <div class="bs-sidebar">
            <ul id="ul_object" class="nav nav-list bs-sidenav">
				<sup><i class="fa fa-question-circle tooltips pull-right" style="font-size : 1em;color:grey;" title="Les 'NON' sont prioritaires aux 'OUI'. Si vous voulez voir uniquement les piles salons (par exemple), il faut mettre oui partout dans les catégories Santé, Piles, Plugins ; et dans la catégorie pièce avoir uniquement Salon sur Oui. Ainsi vous verrez toutes les piles dans le salon et pas ailleurs et ceci quelquesoit le plugin, la santé et le type de piles. Pour voir les piles salons uniquement AAA, il faut OUI partout dans santé, OUI partout dans plugins ; dans pièce uniquement Salon sur OUI et dans Piles uniquement AAA sur oui etc...."></i></sup>
