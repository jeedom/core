...
include_file('3rdparty', 'pages/pace-theme-flash', 'css');
//include_file('3rdparty', 'jquery.scrollbar/jquery.scrollbar', 'css');
//include_file('3rdparty', 'select2/select2', 'css');
//include_file('3rdparty', 'switchery/switchery.min', 'css');
include_file('3rdparty', 'pages/pages-icons', 'css');
include_file('3rdparty', 'pages/pages', 'css');
										...
										<div class="sidebar-menu">
											...
											<ul class="menu-items">
												<li class="m-t-30 open">
													<a href="javascript:;"><span class="title">Accueil</span>
													...
													<li class="">
														<a href="javascript:;"><span class="title">Général</span>
															<span class=" arrow"></span></a>
																...
																<li>
																	<a href="javascript:;"><span class="title">Administration</span>
																		...
																		<ul class="sub-menu">
																			...
																			<li>
																				<a href="ujavascript:;">Utilisateurs</a>
																				<span class="icon-thumbnail"><i class="fa fa-users"></i></span>
																			</li>
																			<li>
																				<a href="javascript:;">Gestion des droits avancés</a>
																				<span class="icon-thumbnail"><i class="fa fa-graduation-cap"></i></span>
																			</li>
																			<li>
																				<a href="ujavascript:;">Sauvegarde</a>
																				<span class="icon-thumbnail"><i class="fa fa-floppy-o"></i></span>
																			</li>
																			<li>
																				<a href="javascript:;">Centre de mise à jour</a>
																				<span class="icon-thumbnail"><i class="fa fa-refresh"></i></span>
																			</li>
																			<li>
																				<a href="ujavascript:;">Réseau Jeedom</a>
																				<span class="icon-thumbnail"><i class="fa fa-sitemap"></i></span>
																			</li>
																			<li>
																				<a href="javascript:;">Moteur de tâches</a>
																				<span class="icon-thumbnail"><i class="fa fa-tasks"></i></span>
																			</li>
																			<li>
																				<a href="ujavascript:;">Sécurité</a>
																				<span class="icon-thumbnail"><i class="fa fa-lock"></i></span>
																			</li>
																			<li>
																			...
																			<li>
																				<a href="ujavascript:;">Informations système</a>
																				<span class="icon-thumbnail"><i class="fa fa-tachometer"></i></span>
																			</li>
																			<li>
																				<a href="ujavascript:;">Personnalisation avancée</a>
															...
															<li class="">
																<a href="javascript:;"><span class="title">Plugins</span>
																	<span class=" arrow"></span></a>
																	<span class="icon-thumbnail"><i class="fa fa-tasks"></i></span>
																	<ul class="sub-menu">
																		<li>
																			<a href="javascript:;"><span class="title">Panel</span>
																				<span class="arrow"></span></a>
																				<span class="icon-thumbnail"><i class="fa fa-thumb-tack"></i></span>
																				<ul class="sub-menu">
																					<li>
																						<a href="javascript:;">Energie</a>
																						<span class="icon-thumbnail"><i class="fa fa-bolt"></i></span>
																					</li>
																				</ul>
																			</li>
																			<li>
																				<a href="javascript:;"><span class="title">Protocol domotique</span>
																					<span class="arrow"></span></a>
																					<span class="icon-thumbnail"><i class="fa fa-rss"></i></span>
																					<ul class="sub-menu">
																						<li>
																							<a href="javascript:;">Z-wave</a>
																							<span class="icon-thumbnail"><i class="fa fa-rss"></i></span>
																						</li>
																					</ul>
																				</li>
																				<li>
																					<a href="javascript:;"><span class="title">Communication</span>
																						<span class="arrow"></span></a>
																						<span class="icon-thumbnail"><i class="fa fa-comment-o"></i></span>
																						<ul class="sub-menu">
																							<li>
																								<a href="javascript:;">AutoRemote</a>
																								<span class="icon-thumbnail"><i class="fa fa-mobile"></i></span>
																							</li>
																							<li>
																								<a href="javascript:;">Freebox OS</a>
																								<span class="icon-thumbnail"><i class="fa fa-mobile"></i></span>
																							</li>
																							<li>
																								<a href="javascript:;">Freebox TV</a>
																								<span class="icon-thumbnail"><i class="fa fa-mobile"></i></span>
																							</li>
																							<li>
																					...
																					<li>
																						<a href="javascript:;"><span class="title">Multimédia</span>
																							<span class="arrow"></span></a>
																							<span class="icon-thumbnail"><i class="fa fa-sliders"></i></span>
																							<ul class="sub-menu">
																								<li>
																									<a href="javascript:;">Squeezebox</a>
																			...
																			<div class=" pull-left sm-table">
																				<div class="header-inner">
																					<div class="brand inline">
																						<img src="assets/img/logo.png" alt="logo" data-src="assets/img/logo.png" data-src-retina="assets/img/logo.png" width="100" height="50">
																					</div>
																				</div>
																			</div>
																			...
																			<div class=" pull-right">
																				...
																				<div class="visible-lg visible-md m-t-10">
																					<div class="pull-left p-r-10 p-t-10 fs-16 font-heading">
																						<span class="semi-bold">Erwann</span> <span class="text-master">Laville</span>
																					</div>
																					<div class="dropdown pull-right">
																						...
																						<ul class="dropdown-menu profile-dropdown" role="menu">
																							<li><a href="#"><i class="fa fa-briefcase"></i> Profil</a>
																							</li>
																							<li><a href="#"><i class="fa fa-check-square-o"></i> Mode Expert</a>
																							</li>
																							<li><a href="#"><i class="fa fa-repeat"></i> Redémarrer</a>
																							</li>
																							<li><a href="#"><i class="fa fa-power-off"></i> Eteindre</a>
																							</li>
																							<li><a href="#"><i class="fa fa-mobile"></i> Version mobile</a>
																							</li>
																				...
																				<div class="header-inner">
																					...
																					<ul class="notification-list no-margin hidden-sm hidden-xs b-grey b-l b-r no-style p-l-30 p-r-20">
																						<li class="p-r-15 inline">
																							<div class="dropdown">
																								<a href="javascript:;" id="notification-center" class="fa fa-bell" data-toggle="dropdown">
																								...
																								<div class="dropdown-menu notification-toggle" role="menu" aria-labelledby="notification-center">
																									<div class="notification-panel">
																											...
																											<div class="notification-item  clearfix">
																												<div class="heading">
																													<a href="#" class="text-danger">
																														...
																														<span class="bold">3 mises à jour disponibles</span>
																													</a>
																													<span class="pull-right time">17h45</span>
																												</div>
																											</div>
																										...
																										<div class="notification-footer text-center">
																											<a href="#" class="">Voir toutes les notifications</a>
																										</div>
																			...
																			<div class="container-fluid container-fixed-lg footer">
																				<div class="copyright sm-text-center">
																					<p class="small no-margin pull-left sm-pull-reset">
																						...
																						<span class="font-montserrat">Jeedom (v.1.178.0)</span>
																					</p>
																					<p class="small no-margin pull-right sm-pull-reset">
																						<span class="hint-text">Page générée en 0.911s</span>
																					</p>
																					<div class="clearfix"></div>
																				</div>
																			</div>
...
//include_file('3rdparty', 'pages/pace.min', 'js');
include_file('3rdparty', 'modernizr/modernizr.custom', 'js');
include_file('3rdparty', 'jquery.easy/jquery-easy', 'js');
//include_file('3rdparty', 'jquery.unveil/jquery.unveil.min', 'js');
//include_file('3rdparty', 'jquery.bez/jquery.bez.min', 'js');
//include_file('3rdparty', 'jquery.ioslist/jquery.ioslist.min', 'js');
//include_file('3rdparty', 'imagesloaded/imagesloaded.pkgd.min', 'js');
include_file('3rdparty', 'jquery.actual/jquery.actual.min', 'js');
include_file('3rdparty', 'jquery.scrollbar/jquery.scrollbar.min', 'js');
include_file('3rdparty', 'pages/pages', 'js');
