						...
						<div class="form-group">
							...
							<div class="col-md-6 col-xs-8">
								<div class="input-group">
									...
									<input type="number" min="30" step="10" max="300" class="configKey form-control ispin" data-l1key="widget::step::height" data-reload="1" placeholder="30">
									<span class="input-group-addon ">{{Largeur}}</span>
									<input type="number" min="40" step="10" max="300" class="configKey form-control ispin roundedRight" data-l1key="widget::step::width" data-reload="1" placeholder="40">
								</div>
							</div>
						</div>
						<div class="form-group">
