                            ...
                            <?php if (config::byKey('jeeNetwork::mode') == 'master') {?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6 expertModeVisible">
                                      <label>
                                          <input type="checkbox" class="configKey tooltips" data-l1key="generateTranslation" title="{{Option pour les developpeurs permetant à Jeedom de générer les phrases à traduire}}" /> {{Généré les traductions}}
                                      </label>
                                  </div>
                              </div>
                              <div class="form-group">
