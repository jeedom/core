        ...
        <div class="panel-body">
            <form class="form-horizontal">
                <fieldset>
                    ...
                    <div class="form-group expertModeVisible">
                        <label class="col-lg-2 col-md-3 col-sm-4 col-xs-6 control-label">{{Activer le market}}</label>
                        <div class="col-sm-1">
                            <input type="checkbox" class="configKey bootstrapSwitch" data-l1key="market::enable"/>
                        </div>
                    </div>
                    <div class="div_marketConfiguration" style="display:none;">
                        <div class="form-group">
                            <label class="col-lg-2 col-md-3 col-sm-4 col-xs-6 control-label">{{Adresse}}</label>
