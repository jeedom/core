			...
			<form class="form-horizontal">
				<fieldset>
					...
					<div class="form-group">
						...
						<div class="col-lg-3 col-md-4 col-sm-5 col-xs-6">
							<a class="btn btn-warning" id="bt_consistency" style="width:50%;"><i class="fas fa-check"></i> {{Lancer}}</a>
							<a id="bt_logConsistency" class="btn btn-success" target="_blank" title="{{Ouvrir le log Consistency.}}"><i class="far fa-file-alt"></i> {{Log}}</a>
						</div>
					</div>
