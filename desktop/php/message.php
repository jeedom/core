...
<div class="input-group pull-right" style="display:inline-flex">
	<select id="sel_plugin" class="form-control roundedLeft" style="width: 200px;">
	...
	<span class="input-group-btn">
		<a class="btn btn-default" id="bt_refreshMessage"><i class="fas fa-sync icon-white"></i> {{Rafraichir}}</a><a class="btn btn-danger roundedRight" id="bt_clearMessage"><i class="far fa-trash-alt icon-white"></i> {{Vider}}</a>
	</span>
</div>
