 ...
 */
 ...
 $('#bt_accessDB').on('click', function () {
    ...
    bootbox.confirm('{{Attention, ceci est une opération risquée. Confirmez-vous que vous comprenez bien les risques et qu\'en cas de Jeedom non fonctionel par la suite, aucune demande de support ne sera acceptée (cette tentative d\'accès est enregistrée) ?}}', function (result) {
        if (result) {
