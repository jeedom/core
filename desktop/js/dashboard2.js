...
function getObjectHtml(_object_id){
  jeedom.object.toHtml({
    ...
    success: function (html) {
      ...
      $('#div_ob'+_object_id+'.div_displayEquipement .eqLogic-widget').addClass('grid-stack-item');
      $('#div_ob'+_object_id+'.div_displayEquipement').addClass('grid-stack-item');
      $('#div_ob'+_object_id+'.div_displayEquipement').gridstack();
