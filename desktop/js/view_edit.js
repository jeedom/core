...
function addGraphService(_viewData){
    ...
    tr += '<option value="sum::day">{{Sommes par jour}}</option>'
    ...
    tr += '<option value="sum::week">{{Sommes par semaine}}</option>'
    ...
    tr += '<option value="sum::month">{{Sommes par mois}}</option>'
    ...
    tr += '</td>';
    tr += '<td>';
    tr += '<input type="checkbox" class="viewDataAttr" data-l1key="configuration" data-l2key="graphStep">'
    tr += '</td>';
    tr += '<td>';
    tr += '<input type="checkbox" class="viewDataAttr" data-l1key="configuration" data-l2key="graphStack">'
    tr += '</td>';
    tr += '<td>';
    tr += '<input type="checkbox" class="viewDataAttr" data-l1key="configuration" data-l2key="derive">'
    tr += '</td>';
    tr += '</tr>';
    var result = $(tr);
