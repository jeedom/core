...
RUN sh /root/install_docker.sh -s 1
RUN sh /root/install_docker.sh -s 2
RUN sh /root/install_docker.sh -s 4
RUN sh /root/install_docker.sh -s 5
RUN sh /root/install_docker.sh -s 8
RUN sh /root/install_docker.sh -s 11
