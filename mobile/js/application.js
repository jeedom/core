...
function triggerThemechange() {
  ...
  if (currentTheme.endsWith('Light')) {
    $('#homeLogoImg').attr('src', ('../../'+jeedom.theme.logo_light).replace('logo-jeedom', 'jeedom_home'))
  } else {
    $('#homeLogoImg').attr('src', ('../../'+jeedom.theme.logo_dark).replace('logo-jeedom', 'jeedom_home'))
  }
