function initHome() {
    ...
    jeedom.view.all({
        ...
        success: function (views) {
            var li = '';
            for (var i in views) {
                li += '<a href="#" class="link ui-bottom-sheet-link ui-btn ui-btn-inline waves-effect waves-button" data-page="view" data-title="' + views[i].name + '" data-option="' + views[i].id + '">' + views[i].name + '</a>'
            }
