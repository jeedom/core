...
Tunnel.prototype._init = function(cb) {
    ...
    var authentification = opt.authentification;

    // where to quest
    params.uri = base_uri + ((assigned_domain) ? assigned_domain+'?authentification='+opt.authentification : '?new&authentification='+opt.authentification);
