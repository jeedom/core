...
try {
    ...
    if (!file_exists($tmp . "/DB_backup.sql")) {
        throw new Exception(__('Impossible de trouver le fichier de sauvegarde de la base de données dans l\'archive : DB_backup.sql', __FILE__));
    }
    jeedom::stop();
    ...
    echo __('Erreur durant la sauvegarde : ', __FILE__) . $e->getMessage();
