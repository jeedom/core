...
class Container_4feaa7996f extends _PHPStan_ce257d9ac\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService062(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_4feaa7996f $container)
			{
	...
	public function createServiceContainer(): Container_4feaa7996f
	{
		return $this;
	}
