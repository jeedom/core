...
- **status** : *ATrrêté* or *Running*, it indicates the current state of the scenario.
...
You can also trigger a scenario when a variable is updated by putting : #variable(nom_variable)# or en utilisant l'API HTTP décrite [here](https://jeedom.github.io/core/en_US/api_http).
