...
-   **Filter administrators (optional)** : filter administrators on the AD (for managing
    groups for example)

-   **Filter users (optional)** : filter users on the AD (for managing
    groups for example)

-   **Filter limited users (optional)** : filter limited users on the AD (for managing
    groups for example)
