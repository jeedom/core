...
- **Namebre maximum d'évènements** : Defines the maximum number of events to display in the timeline.
...
- **Theier à un virtuel** : Launches the creation of virtual command having for value those of the summary.
...
- **Namebre d'échecs tolérés** : defines the number of successive attempts allowed before banning the IP
