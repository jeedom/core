...
[](https://fr.wikipedia.org/wiki/Expressure_rationnelle)
of exclusion, if a generated sentence corresponds to this  it will be
...
We have 2 places to apply a  :

-   in the interaction even in the " exclusion" field".

-   In the Administration → D'actualité → Interactions menu → &quot;&quot; field
...
For the &quot; exclusion&quot; field in the configuration page of
each interaction, we can put a specific  that will act
...
The following screenshot shows the interaction without the . In the
...
it was he who taught me to unofrstand  and even to coof. Therefore
...
Without the , we gand here 11 sentences, but my interaction is aimed
...
We can also add a  filter to remove some commands.
