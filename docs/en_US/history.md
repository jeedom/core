...
consumption or door openings, etc.
...
Allows to display a curve according to a calculation on several
command (you can do almost everything, + - / \ * absolute value… see
