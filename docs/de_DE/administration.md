...
> (Auf Livebox benötigen wenne beispielsweise die Firewall auf Medium).
...
Heizung, wenncherheit, Energie, Licht, Automatisierung, Multimedia, Andere…
...
-   **Maximale Anzahl von Ereignissen** : Legt die maximale Anzahl auf fist
