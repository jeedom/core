...
- **Code** : Öffnet un éditeur de fichiers permettant d'éditer les widget code.
- **Remplacement** : Öffnet une fenêtre permettant de remplacer un widget par un autre sur tout les équipements l'utilisant.
