...
Das Prinzip ist ganz einfach : Eine Ansicht besteht aus Bereichen. Jede Zone ist vom Typ *Diagramm*, *Widget* Oder *malen*. Abhängig von diesem Typ können Sie Grafiken, Geräte oder Befehle hinzufügen.
...
- **Stufen** : Zeigt die Treppenkurve an.
