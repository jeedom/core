...
3.3.34
=====
- Es wurde ein Fehler behoben, der verhindern konnte, dass der Akku wieder hochfuhr
...
- Fehlerbehebungen
- Deaktivieren von Aktionen für Aufträge beim Bearbeiten von Designs, Ansichten oder Armaturenbretts
...
- Optimierung organisatorischer Änderungen (Größe der Widgets, Position der Ausrüstung, Position der Befehle) im Armaturenbrett und in den Ansichten. Bitte beachten Sie, dass die Änderungen nur beim Verlassen des Bearbeitungsmodus gespeichert werden.
...
- Möglichkeit, Geräte-Widgets über das Armaturenbrett neu zu organisieren (im Bearbeitungsmodus klicken Sie mit der rechten Maustaste auf das Widget)
...
- Hinzufügen von Vor- und Nachbestellungen zu einer Bestellung. Ermöglicht das Auslösen einer Aktion vor oder nach einer anderen Aktion. Kann auch die Synchronisierung von Geräten ermöglichen, sodass beispielsweise 2 Lichter immer zusammen mit der gleichen Intensität aufleuchten.
...
- Korrektur von Backup / Restore-Fehlern, wenn der Jeedom-Name Sonderzeichen enthält
...
- Passage im Modul der Verbindung mit dem Markt (ermöglicht eine Freiheit ohne Verbindung zum Markt)
...
- Hinzufügung für ein bestimmtes &quot;Repo&quot; der Möglichkeit, den Kern der Freiheit wiederzugewinnen
...
- Jeedom \ _poweroff-Aktion in Szenarien hinzugefügt, um Jeedom zu stoppen
...
- Löschen Sie alle Netzwerkverwaltungsteile : WiFi, feste IP… (wird sicherlich als Plugin zurückkommen). ACHTUNG: Es wird nicht der Jeedom Master / Slave-Modus gelöscht
