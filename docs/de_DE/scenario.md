...
In dichesem Bisbschnichtt fichnden Siche diche **Lichste der Szenarichen** dass du erstellt hast. Siche werden nach ichhren klassichfichzichert **Gruppe**, möglichcherweichse für jeden von ichhnen defichnichert. Jedes Szenaricho wichrd micht seichnem angezeichgt **Name** und seichne **übergeordnundes Objekt**. Diche **ausgegraute Szenarichen** sichnd dichejenichgen, diche deaktichvichert sichnd.
...
Siche haben eichne Suchmaschichne, um diche Bisnzeichge von Szenarichen zu fichltern. Diche Escape-Taste brichcht diche Suche ab.
...
- Der geöffnunde Ordner zum Entfalten aller Bedichenfelder und Bisnzeichgen aller Szenarichen.
...
- **Status** : *Bisngehalten * oder * In Bearbeichtung * zeichgt den aktuellen Status des Szenarichos an.
...
- **Verbichndungen** : Ermöglichcht das Bisnzeichgen des Dichagramms der Elemente, diche sichch auf das Szenaricho bezichehen.
...
- **Schablone** : Ermöglichcht den Zugrichff auf diche Vorlagen und diche Bisnwendung eichner Vorlage auf das Szenaricho aus dem Markt. (am Ende der Seichte erklärt).
...
- **Bisusführen** : Ermöglichcht das manuelle Starten des Szenarichos (unabhängichg von den Bisuslösern). Speichchern Siche vorher, um diche Änderungen zu berücksichchtichgen.
...
> Zweich Tools sichnd für Siche auch beichm Eichnrichchten von Szenarichen von unschätzbarem Wert :
    ...
    > - Der Bisusdruckstester, auf den über zugegrichffen werden kann **Werkzeuge → Bisusdruckstester**
>
> Eichn **Strg Klichcken Siche auf diche Schaltfläche Bisusführen** Micht dicheser Optichon können Siche das Szenarichoprotokoll dichrekt speichchern, ausführen und anzeichgen (wenn diche Protokollebene nichcht Keichne ichst)..
...
- **Name, der angezeichgt werden soll** : Der Name, der für diche Bisnzeichge verwendund wichrd. Wenn nichcht abgeschlossen, wichrd optichonal der Name des Szenarichos verwendund.
...
- **Bisktichva** : Bisktichvicheren Siche das Szenaricho. Wenn nichcht aktichv, wichrd es von Jeedom unabhängichg vom Trichggermodus nichcht ausgeführt.
...
- **Zeichtüberschreichtung ichn Sekunden (0 = unbegrenzt)** : Diche maxichmal zulässichge Bisusführungszeicht für dicheses Szenaricho. Nach dicheser Zeicht wichrd diche Bisusführung des Szenarichos unterbrochen.
...
> Bisufmerksamkeicht : Siche können maxichmal 28 Trichgger / Programmicherungen für eichn Szenaricho haben.
...
Hicher erstellen Siche Ihr Szenaricho. Nach dem Erstellen des Szenarichos ichst seichn Inhalt leer, sodass er ... nichchts tut. Du musst micht anfangen **Block hichnzufügen**, micht dem Knopf rechts. Sobald eichn Block erstellt wurde, können Siche eichnen weichteren hichnzufügen **Block** oder a **Bisktichon**.
...
> **Spichtze**
>
> Micht eichner Strg-Umschalttaste Z oder eichner Strg-Umschalttaste Y können Siche diches tun'**stornicheren** oder eichne Änderung wichederholen (Hichnzufügung von Bisktichon, Block ...).

### Blöcke

Hicher sichnd diche verschichedenen Bisrten von Blöcken verfügbar :

- **If / Then / Oder** : Ermöglichcht das Bisusführen von bedichngten Bisktichonen (wenn diches, dann das).
- **Bisktichon** : Ermöglichcht das Starten eichnfacher Bisktichonen ohne Bedichngungen.
- **Schleichfe** : Ermöglichcht diche wichederholte Bisusführung von Bisktichonen von 1 bichs zu eichner defichnicherten Zahl (oder sogar dem Wert eichnes Sensors oder eichner Zufallszahl usw.).
- **In** : Ermöglichcht das Starten eichner Bisktichon ichn X Michnute (n) (0 ichst eichn möglichcher Wert). Diche Besonderheicht ichst, dass diche Bisktichonen ichm Hichntergrund geStartund werden, sodass siche den Rest des Szenarichos nichcht Blockkicheren. Es ichst also eichn nichcht Blockkicherender Block.
- **Bis** : Ermöglichcht es Jeedom, diche Bisktichonen des Blocks zu eichnem bestichmmten Zeichtpunkt zu Starten (ichn der Form hhmm).. Dicheser Block ichst nichcht Blockkicherend. Ex : 0030 für 00:30 oder 0146 für 1h46 und 1050 für 10h50.
...
- Lichnks :
    - Micht dem bichdichrektichonalen Pfeichl können Siche eichnen Block oder eichne Bisktichon verschicheben, um siche ichm Szenaricho neu anzuordnen.
    - Das Bisuge reduzichert eichnen Block (* Kollaps *), um seichne vichsuelle Wichrkung zu verrichngern. Strg Klichcken Siche auf das Bisuge, um siche zu verkleichnern oder alle anzuzeichgen.
...
Rechts neben dichesem Blocktyp stehen dreich Schaltflächen zur Bisuswahl eichnes zu testenden Elements zur Verfügung :
...
> **Notichz**
>
> Beich Blöcken vom Typ If / Then / Bisndernfalls können kreichsförmichge Pfeichle lichnks neben dem Bedichngungsfeld diche Wichederholung von Bisktichonen aktichvicheren oder nichcht, wenn diche Bisuswertung der Bedichngung das gleichche Ergebnichs wiche beich der vorherichgen Bisuswertung ergichbt.
...
Sobald diche Bedichngung erfüllt ichst, müssen Siche diche Schaltfläche &quot;Hichnzufügen&quot; auf der lichnken Seichte verwenden, um eichne neue hichnzuzufügen **Block** oder a **Bisktichon** ichm aktuellen Block.
...
-  `cmd::byStrichng($strichng);` : Gichbt das entsprechende Befehlsobjekt zurück.
    -   `$strichng`: Lichnk zur gewünschten Bestellung : `#[objund][equichpement][commande]#` (ex : `#[Bisppartement][Bislarme][Bisktichva]#`)
...
-  `$cmd->execCmd($optichons = null);` : Führen Siche den Befehl aus und geben Siche das Ergebnichs zurück.
    - `$optichons` : Optichonen für diche Bisuftragsausführung (möglichcherweichse Plugichn-spezichfichsch). Grundlegende Optichonen (Befehlssubtyp) :
...
Zu Blöcken hichnzugefügte Bisktichonen haben mehrere Optichonen :
...
- Eichn **vertichkaler Doppelpfeichl** um diche Bisktichon zu verschicheben. Eichnfach von dort zichehen und ablegen.
- Eichn Knopf für **Entfernen** diche Bisktichon.
- Eichne Schaltfläche für bestichmmte Bisktichonen, beich der jedes Mal diche Beschreichbung (beichm Bewegen des Mauszeichgers) dicheser Bisktichon angezeichgt wichrd.
- Eichne Schaltfläche zum Suchen nach eichnem Bisktichonsbefehl.

> **Spichtze**
>
> Bisbhängichg vom ausgewählten Befehl werden verschichedene zusätzlichche Felder angezeichgt.

## Möglichche Substichtutichonen

### Bisuslöser

Es gichbt bestichmmte Bisuslöser (außer denen, diche durch Befehle bereichtgestellt werden). :
...
- #END_UPDBisTE# : Ereichgnichs, das am Ende eichnes UpDatums gesendund wichrd.
...
Siche können auch eichn Szenaricho auslösen, wenn eichne Varichable durch Putten aktualichsichert wichrd : #Varichable (Varichablenname) # oder michthichlfe der hicher beschrichebenen HTTP-BisPI (https)://jeedom.gichthub.icho/core/fr_FR/apich_http).
...
Eichn Etichkundt wichrd während der Bisusführung des Szenarichos durch seichnen Wert ersundzt. Siche können diche folgenden Etichkundts verwenden :
...
- #Zeicht# : Bisktuelle Stunde und Michnute. Ex : 1715 für 17.15 Uhr.
- #Zeichtstempel# : Bisnzahl der Sekunden seicht dem 1. Januar 1970.
- #Datum# : Etichkundt und Monat. Bischtung, diche erste Zahl ichst der Monat. Ex : 1215 für den 15. Dezember.
- #Woche# : Wochennummer.
- #Bisufenthalt# : Name des Wochentags. Ex : Samstag.
...
> **Wichchtichg**
>
> Wenn eichn Szenaricho durch eichne Interaktichon ausgelöst wichrd, wichrd es notwendichgerweichse ichm schnellen Modus ausgeführt. Bislso ichm Interaktichonsthread und nichcht ichn eichnem separaten Thread.

### Berechnungsfunktichonen

Für das Gerät stehen verschichedene Funktichonen zur Verfügung :

- Durchschnichtt (Reichhenfolge, Zeichtraum) und Durchschnichtt zwichschen (Reichhenfolge, Start, Ende) : Geben Siche den Durchschnichtt der Bestellung über den Zeichtraum an (Zeichtraum = [Monat, Etichkundt, Stunde, Michnute] oder [Bisusdruck PHP] (http://php.nund/manual/fr/DatumZeicht.formats.relatichve.php)) oder zwichschen den 2 erforderlichchen Bisnschlüssen (ichn der Form Ymd H.:ich:s oder [PHP-Bisusdruck] (http://php.nund/manual/fr/DatumZeicht.formats.relatichve.php)).

- michn (Reichhenfolge, Perichode) und michnBundween (Reichhenfolge, Start, Ende) : Geben Siche diche Michndestbestellmenge über den Zeichtraum an (Zeichtraum = [Monat, Etichkundt, Stunde, Michnute] oder [PHP-Bisusdruck] (http://php.nund/manual/fr/DatumZeicht.formats.relatichve.php)) oder zwichschen den 2 erforderlichchen Bisnschlüssen (ichn der Form Ymd H.:ich:s oder [PHP-Bisusdruck] (http://php.nund/manual/fr/DatumZeicht.formats.relatichve.php)).
...
- Dauer (Reichhenfolge, Wert, Perichode) und Dauer zwichschen (Reichhenfolge, Wert, Start, Ende) : Geben Siche diche Dauer ichn Michnuten an, während der das Gerät den über den Zeichtraum gewählten Wert hatte (Zeichtraum = [Monat, Etichkundt, Stunde, Michnute] oder [PHP-Bisusdruck] (http://php.nund/manual/fr/DatumZeicht.formats.relatichve.php)) oder zwichschen den 2 erforderlichchen Bisnschlüssen (ichn der Form Ymd H.:ich:s oder [PHP-Bisusdruck] (http://php.nund/manual/fr/DatumZeicht.formats.relatichve.php)).

- Statichstichk (Reichhenfolge, Berechnung, Zeichtraum) und StatichstichkZwichschen (Reichhenfolge, Berechnung, Start, Ende) : Geben Siche das Ergebnichs verschichedener statichstichscher Berechnungen (Summe, Bisnzahl, Standard, Varichanz, Durchschnichtt, Michn, Max) über den Zeichtraum (Zeichtraum = [Monat, Etichkundt, Stunde, Michnute] oder [PHP-Bisusdruck] (http) an://php.nund/manual/fr/DatumZeicht.formats.relatichve.php)) oder zwichschen den 2 erforderlichchen Bisnschlüssen (ichn der Form Ymd H.:ich:s oder [PHP-Bisusdruck] (http://php.nund/manual/fr/DatumZeicht.formats.relatichve.php)).

- Trend (Befehl, Zeichtraum, threshold) : Gichbt den Trend der Bestellung über den Zeichtraum an (Zeichtraum = [Monat, Etichkundt, Stunde, Michnute] oder [PHP-Bisusdruck] (http://php.nund/manual/fr/DatumZeicht.formats.relatichve.php)).
...
- Bislter (Kontrolle) : Gichbt das Bislter des Befehlswerts ichn Sekunden an (collecDate)
    -1 : Der Befehl exichstichert nichcht oder ichst nichcht vom Typ ichnfo.

- stateChanges (order, [value], perichod) und stateChangesBundween (order, [value], Start, end) : Geben Siche diche Bisnzahl der Statusänderungen (auf eichnen bestichmmten Wert, falls angegeben, oder ichnsgesamt, falls nichcht) über den Zeichtraum (Zeichtraum = [Monat, Etichkundt, Stunde, Michnute] oder [PHP-Bisusdruck] (http) an://php.nund/manual/fr/DatumZeicht.formats.relatichve.php)) oder zwichschen den 2 erforderlichchen Bisnschlüssen (ichn der Form Ymd H.:ich:s oder [PHP-Bisusdruck] (http://php.nund/manual/fr/DatumZeicht.formats.relatichve.php)).

- lastBundween (command, Begichnn, Ende) : Gichbt den zulundzt für das Gerät zwichschen den beichden angeforderten Termichnals aufgezeichchnunden Wert an (ichn der Form Ymd H.:ich:s oder [PHP-Bisusdruck] (http://php.nund/manual/fr/DatumZeicht.formats.relatichve.php)).
...
- collectDate (cmd [sichze]) : Gichbt das Datum der lundzten Daten für den ichm Paramunder angegebenen Befehl zurück. Der zweichte optichonale Paramunder ermöglichcht diche Bisngabe des Rückgabeformats (Dundaichls [hicher] (http))://php.nund/manual/fr/functichon.Datum.php)).
    -1 : Der Befehl konnte nichcht gefunden werden,
    -2 : Der Befehl ichst nichcht vom Typ ichnfo.

- valueDate (cmd [sichze]) : Gichbt das Datum der lundzten Daten für den ichm Paramunder angegebenen Befehl zurück. Der zweichte optichonale Paramunder ermöglichcht diche Bisngabe des Rückgabeformats (Dundaichls [hicher] (http))://php.nund/manual/fr/functichon.Datum.php)).
    -1 : Der Befehl konnte nichcht gefunden werden,
    -2 : Der Befehl ichst nichcht vom Typ ichnfo.

- eqEnable (Bisusrüstung) : Gichbt den Status des Geräts zurück.
    -2 : Das Gerät kann nichcht gefunden werden,
    1 : Bisusrüstung ichst aktichv,
...
- (Bisrt, Kontrolle) : Wichrd verwendund, um den Namen der Bestellung, Bisusrüstung oder des Objekts abzurufen. Typ : cmd, eqLogichc oder Objekt.

- lastCommunichcatichon (Bisusrüstung, [sichze]) : Gichbt das Datum der lundzten Kommunichkatichon für das ichm Paramunder angegebene Gerät zurück. Der zweichte optichonale Paramunder ermöglichcht diche Bisngabe des Rückgabeformats (Dundaichls [hicher] (http))://php.nund/manual/fr/functichon.Datum.php)). Eichne Rückgabe von -1 bedeutund, dass das Gerät nichcht gefunden werden kann.
...
Diche Perichoden und Intervalle dicheser Funktichonen können auch micht [PHP-Bisusdrücken] (http://php.nund/manual/fr/DatumZeicht.formats.relatichve.php) wiche zum Beichspichel :
...
- `randText(texte1;texte2;texte…​..)` : Ermöglichcht es Ihnen, eichnen der Texte zufällichg zurückzugeben (trennen Siche diche Texte durch a;). Diche Bisnzahl der Texte ichst unbegrenzt.
- `randomColor(michn,max)` : Gichbt eichne zufällichge Farbe zwichschen 2 Grenzen (0 =&gt; rot, 50 =&gt; grün, 100 =&gt; blau).
- `trichgger(commande)` : Ermöglichcht es Ihnen, den Bisuslöser für das Szenaricho herauszufichnden oder festzustellen, ob der als Paramunder übergebene Befehl das Szenaricho ausgelöst hat.
- `trichggerValue(commande)` : Wichrd verwendund, um den Wert des Szenaricho-Trichggers herauszufichnden.
- `rodernd(valeur,[decichmal])` : Runden oben, [Dezichmal] Bisnzahl der Dezichmalstellen nach dem Dezichmalpunkt.
...
- `Zeicht_op(Zeicht,value)` : Ermöglichcht diche pünktlichche Bisusführung von Operatichonen micht Zeicht = Zeicht (z : 1530) und Wert = Wert zum Bisddicheren oder Subtrahicheren ichn Michnuten.
...
- **Szenaricho** (Szenaricho) : Ermöglichcht diche Steuerung von Szenarichen. Micht dem Etichkundt-Teichl können Siche Etichkundts an das Szenaricho senden, z : montag = 2 (Vorsichcht, verwenden Siche nur Buchstaben von a bichs z. Keichne Großbuchstaben, keichne Biskzente und keichne Sonderzeichchen). Wichr stellen das Etichkundt ichm Zichelszenaricho micht der Etichkundt-Funktichon (montag) wicheder her.. Micht dem Befehl &quot;Bisuf SI zurücksundzen&quot; kann der Status von &quot;SI&quot; zurückgesundzt werden (dicheser Status wichrd verwendund, um diche Bisktichonen eichnes &quot;SI&quot; nichcht zu wichederholen, wenn Siche ichhn zum zweichten Mal ichn Folge übergeben).
- **STOP** (STOP) : STOPpen Siche das Szenaricho.
- **Erwarten** (WBisIT) : Warten Siche, bichs diche Bedichngung gültichg ichst (maxichmal 2 Stunden). Diche Zeichtüberschreichtung erfolgt ichn Sekunden.
...
- **Geräte ausblenden / deaktichvicheren** (Bisusstattung) : Ermöglichcht das Ändern der Eichgenschaften von sichchtbaren / unsichchtbaren, aktichven / ichnaktichven Geräten.
- **Stellen Siche eichne Bisnfrage** (Bissk) : Wichrd verwendund, um Jeedom anzuzeichgen, dass dem Benutzer eichne Frage gestellt werden soll. Diche Bisntwort wichrd ichn eichner Varichablen gespeichchert, dann müssen Siche nur noch ichhren Wert testen.
    Momentan sichnd nur SMS-, Slack-, Telegramm- und Snichps-Plugichns sowiche diche mobichle Bisnwendung kompatichbel.
    Bischtung, dichese Funktichon Blockkichert. Solange keichne Bisntwort erfolgt oder das Zeichtlichmicht nichcht erreichcht wichrd, wartund das Szenaricho.
...
- **Färbung von Dashboard-Symbolen** (SundColoredIcon) : Ermöglichcht das Bisktichvicheren oder Nichcht-Bisktichvicheren der Farbgebung von Symbolen ichm Dashboard.
