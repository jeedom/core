...
Hier erstellen Sie Ihr Szenario. Nach dem Erstellen des Szenarios ist sein Inhalt leer, sodass er ... nichts tut. Du musst mit anfangen **Fügen Sie einen Block hinzu**, mit dem Knopf rechts. Sobald ein Block erstellt wurde, können Sie einen weiteren hinzufügen **Block** oder a **Bisktion**.
...
> **Spitze**
>
> Mit einer Strg-Umschalttaste Z oder einer Strg-Umschalttaste Y können Sie dies tun'**Bisbbrechen** oder eine Änderung wiederholen (Hinzufügung von Bisktion, Block ...).
...
- `$scenario->sundLog($Nachricht);` : Schreiben Sie eine Nachricht in das Szenario-Protokoll.
...
- #END_UPDBisTE# : Ereignis, das am Ende eines UpDatums gesendund wurde.
- #begin_restore# : Ereignis zu Beginn einer Restaurierung gesendund.
- #end_restore# : Ereignis am Ende einer Restaurierung gesendund.
...
- **Färbung von Dashboard-Symbolen** (SundColoredIcon) : Mit dieser Option können Sie die Farbgebung von Symbolen im Dashboard aktivieren oder nicht.
