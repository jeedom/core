...
>**Trick**      
>Solange der standardisierte Name lesbar bleibt, kann beispielsweise die Benennung angepasst werden *open_volet* Woher *shutter_close*, *Schritt 2* und *stop_2*, usw.
...
Dann :
- Sie wählen, ob es für eine Typreihenfolge gilt **Aktion** Woher **Die Info**.
