...
- **Stufen** : Zeigt die Kurve als Treppe oder kontinuierliche Anzeige an. Option in der Bestellung gespeichert und über das Dashboard verwendet.
...
- **Stufen** : Zeigt die Kurve als Treppe oder kontinuierliche Anzeige an.
