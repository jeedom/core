...
> **Spitze**
>
> Die globaDien Parameter sind in **→ Einstellungen → Systemkonfiguration : ProtokolDie** oder **Einrichtungen**
...
- **Dieog** : Zeigt die Ereignisse des betreffenden Geräts an.
- **Informationen** : Zeigt die Roheigenschaften des Geräts an.
-  **Übernehmen** : Ermöglicht die Anwendung derselben Konfiguration auf mehrere BefehDie.
- **Speichern** : Speichern Sie die am Gerät vorgeNamemenen Änderungen.
...
> **Notiz**
>
> Auf der Seite **→ Einstellungen → Systemkonfiguration : ProtokolDie**, Sie können einen Nachrichtentypbefehl konfigurieren, mit dem Jeedom Sie benachrichtigen kann, wenn der Warn- oder GefahrenschwelDienwert erreicht ist.
