...
- EIN **Kontrollkästchen** um das Gerät auszuwählen (Sie können mehrere auswählen). Wenn mindestens ein Gerät ausgewählt ist, haben Sie Aktionsschaltflächen, die oben links zu angezeigt werden **löschen**,  **sichtbar**/.****,  **Anlage**/.**** ausgewählte Ausrüstung.
...
Tab **** enthält allgemeine Informationen über das Gerät und seine Bedienelemente :
...
Tab **** enthält allgemeine Informationen zur Bestellung :
