...
También puede activar un escenario cuando se actualiza una variable poniendo : #variable(nom_variable)# o en utilisant l'API HTTP décrite [aquí](https://jeedom.github.io/core/es_ES/api_http).
