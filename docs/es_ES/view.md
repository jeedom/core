...
El principio es bastante simple : una vista está compuesta de áreas. Cada zona es de tipo *cuadro*, *artilugio* O *cuadro*. Dependiendo de este tipo, puede agregarle gráficos, equipos o comandos.
...
- **Basura** : Eliminar comando del gráfico.
