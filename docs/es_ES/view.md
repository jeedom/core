...
El principio es bastante simple : una vista está compuesta de áreas. Cada zona es de tipo **, ** Dónde **. Dependiendo de este tipo, puede agregarle gráficos, equipos o comandos.
