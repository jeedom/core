...
Una de las páginas principales de Jeedom muestra una cuenta de toda su automatización del hogar..
...
> **punta**
>
> El orden de visualización de los objetos en el Tablero es el visible en **Análisis → Resumen de domótica**. Puede modificar este orden arrastrando y soltando en esta página.
...
Al pasar el mouse sobre una orden, aparecerá un marcador de color en la parte inferior izquierda del mosaico:
...
- A la derecha, un botón le permite cambiar al modo de edición, modificar el orden de los mosaicos (hacer clic, soltar en el widget) o cambiar su tamaño.. También puede en un mosaico, reorganizar el orden de los pedidos.
