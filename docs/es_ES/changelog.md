...
- Nueva página ModalDisplay:
	...
	- Menú de herramientas : Ctrl Click / Click Center en *Notes*, *Probador de expresión*, *Variables*, *Recherche* : Abra la ventana en una pestaña nueva, en pantalla completa.
