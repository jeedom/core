...
- **Laocalhost** : solo se permiten solicitudes del sistema en el que está instalado Jeedom,
...
- **Base de datos** :
    ...
    - **** : Inicia una verificación de la base de datos y limpia las entradas no utilizadas.
    - **Usuario** : ,
    - **Contraseña** : .
