...
-  : Dirección postal de su hogar / sitio.
-  : Superficie y número de ocupantes de su hogar / sitio.
...
- **Acceso interno** : información para unirse a Jeedom desde equipos en la misma red que Jeedom (LAN)
    ...
    - **** : el protocolo a usar, a menudo HTTP.
    - **URL o dirección IP** : Jeedom IP para entrar.
    - **** : el puerto de la interfaz web de Jeedom, generalmente 80.
...
- **Acceso externo** : información para llegar a Jeedom desde fuera de la red local. Para completar solo si no está utilizando Jeedom DNS.
    ...
    - **** : protocolo utilizado para acceso al exterior.
...
- **Proxy para el mercado** : activación proxy.
    ...
    - **** : Ingrese el inicio de sesión proxy,
...
> ****
>
> Para activar el registro de interacción, vaya a la pestaña Configuración → Sistema → Configuración : Registros, luego verifique **** en la lista de abajo.  : los registros serán muy detallados !

### Principal

Aquí tienes tres parámetros :

- **** : Hay 4 niveles de correspondencia (la sensibilidad va de 1 (corresponde exactamente) a 99) para
...
-    **interacciones contextuales** le permite encadenar múltiples solicitudes sin repetir todo, por ejemplo :
    ...
    - *Haz dos preguntas en una :*
        - ** : ¿Cómo es en el dormitorio y en la sala de estar? ?
...
- **** : Token para acceder al depósito privado.
...
Depósito utilizado para conectar Jeedom al mercado, se recomienda encarecidamente utilizar este depósito.  : cualquier solicitud de soporte puede ser rechazada si utiliza un depósito diferente a este.
...
- **** : Número de objetos actualmente en caché.
...
- **** : solo se permiten solicitudes del sistema en el que está instalado Jeedom,
- **** : sin restricciones, cualquier sistema con acceso a su Jeedom podrá acceder a esta API.
