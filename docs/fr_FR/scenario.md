...
-   #trigger# : Peut etre le nom de la commande qui a déclenché le scénario, ou api si le lancement a été déclenché par l'API ou schedule si il a été lancé par une programmation
