...
Pour faire simple, c'est du code (ici html) où l'on a prédéfini certaines parties que vous allez pouvoir configurer comme vous le voulez par l'interface du Core.

Dans le cas des widgets, vous pouvez généralement personnaliser des icônes ou mettre des images de votre choix.
