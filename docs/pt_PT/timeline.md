...
A página Timeline permite que você exiba eventos cronologicamente, como mudanças de pedidos *Informação*, gatilhos de comando *estoque*, e execuções de cenários.
