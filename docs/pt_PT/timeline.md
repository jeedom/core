...
A página Timeline permite que você exiba eventos cronologicamente, como mudanças de pedidos *em formação*, gatilhos de comando *açao*, e execuções de cenários.
