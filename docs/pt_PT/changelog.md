...
- **** : Internacionalização de Widgets de terceiros (código do usuário). Vejo [Desenvolvedor de documentos](https://doc.jeedom.com/pt_PT/dev/core4.2).
...
Os plugins devem respeitar as recomendações sobre a estrutura em árvore de pastas e arquivos : [](https://doc.jeedom.com/pt_PT/dev/plugin_template).
