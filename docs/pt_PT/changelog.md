...
- Corrigido um bug ao restaurar o Jeedom nas versões do MariaDB 10.5.25, 10,6.18, 10.11.8, 11,0.6, 11,1.5, 11,2.4 e 11.4.2 [LINK](https://github.com/jeedom/core/issues/2911)
