...
O princípio é bastante simples : uma vista é composta de áreas. Cada zona é do tipo *gráfico*, *ferramenta* Ou *pintura*. Dependendo desse tipo, você pode adicionar gráficos, equipamentos ou comandos a ele.
