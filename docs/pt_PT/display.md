...
-   **Fronteiras** : .
     :
    `3px blue dashed`  une bordure pointillée de 3px en bOu.
...
-   **Outro**
    ...
    -   **URL impulso** : 
        . 
         : `#value#`  la vaOur de la Ordem, `#cmd_name#`
        
        
         : `#[SalO de bain][Hydrometrie][Humidité]#`, `#eq_name#`  O Nomee 
