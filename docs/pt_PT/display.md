...
> **Dica**
>
> Os parâmetros globais estão em **Configurações → Sistema → Configuração : Histórico**  **Equipamento**
...
Permite definir um nível de alerta (**aviso**  **perigo**) dependendo de certas condições. Por exemplo, se `valor> 8` por 30 minutos, o equipamento pode ficar em alerta **aviso**.
