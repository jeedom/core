...
* Ajout d'un bouton dans la configuration avancée d'un équipement/d'une commande pour voir les évenements de celui-ci/celle-ci
* Les déclencheurs de scénario peuvent maintenant etre des conditions
