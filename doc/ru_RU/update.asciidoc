...
Центр обновления аккумулирует все функции Jeedom и позволяет обновлять функциональность системы, в том числе базового программного обеспечения, плагинов, виджетов, и т.д ...
