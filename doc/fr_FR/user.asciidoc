...
* *Droits* : la possibilité de passer ou non l'utilisateur en mode administrateur (permet d'avoir accès à tout ce qui est configuration de jeedom, création des scénarios, gestion des plugin, configuration des équipement, des désign, des vues...),
