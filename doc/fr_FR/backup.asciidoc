...
Sur cette page vous retrouvez à gauche les paramètres et les boutons d'action et à droite le statut en temps réel de l'action en cours (sauvegarde ou restauration), si vous en avez lancé une.
