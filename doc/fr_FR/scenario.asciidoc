...
* *alert* : permet d'afficher un petit message d'alerte sur toute les navigateurs qui ont une page jeedom d'ouvert. Vous pouvez en plus choisir 4 niveau d'alertes
* *popup* : permet d'afficher un popup qui doit absolument être validé sur toute les navigateurs qui ont une page jeedom d'ouvert.
