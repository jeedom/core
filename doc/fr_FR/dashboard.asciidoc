...
[TIP]
Il est possible, à partir de votre profil, de configurer Jeedom pour que l'arbre des objets et/ou les scénarii soit visible par défaut lorsque vous arrivez sur le Dashboard
