...
Souvent cela du au fait que les équipements sont affectés à un pièce qui n'est pas le fils ou 
à la pièce lui même du premier objet selectionné à gauche dans l'arbre (vous pouvez dans votre profils configurer celui-ci)
