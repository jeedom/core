...
* Ajout d'une action "popup" sur les scénarios : message a valider
...
* Optimisation du chargement des scenarios et page utilisant des actions avec option (type configuration du plugin alarme ou mode)
* Suppression de phpSysInfo pour des questions de sécurité
* Remplacement d'Adminer par une console "simple" dans jeedom
