...
* Correction de bug (en particulier sur les historiques et fonctions statistiques)
* Amélioration du système de mise à jour avec une page de note de version (que vous devez vérifier vous-mêmes avant chaque mise à jour !!!!)
* Correction d'un bug qui recupère les logs lors des restorations
...
** Suppression des images pour faciliter la mise à jour et le multilinguisme
...
* Ajout d'une timeline sur la page historique (attention doit etre activée sur chaque commande et/ou scénario que vous voulez voir apparaître)
...
* Ajout d'un watchdog independant de Jeedom pour vérifier le statuts de MySql et Apache
