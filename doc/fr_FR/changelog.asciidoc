...
** Possibilité d'ajouter une zone macro (transparente) qui peut executer une action lors d'un clic (couplé à un flux video cela permet par exemple d'allumer en lumiere en cliquant dessus)
