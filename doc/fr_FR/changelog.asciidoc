...
* Amélioration du système de mise à jour avec une page de note de version (que vous devez vérifier vous-même avant chaque mise à jour !!!!)
* Correction d'un bug qui recupère les logs lors des restaurations
