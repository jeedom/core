...
* Un double clique sur la ligne d'une commande (sur la page de configuration) ouvre maintenant la configuration avancée de celle-ci
* Possibilité d'interdire certaine valeur pour une commande (dans la configuration avancée de celle-ci)
...
* Jeedom sait gerer plusieurs interaction liée (contextuellement) en une. Elles doivent être séparées par un mot clef (par defaut et). Exemple : "Combien fait-il dans la chambre et dans le salon ?" ou "Allume la lumière de la cuisine et de la chambre."
...
* Possibilité d'exporter un pnael d'un plugin en PDF,PNG,SVG ou JPEG avec la commande "report" dans un scénario
* Ajout d'une page de gestion de rapport (pour les retelecharger ou les supprimer)
