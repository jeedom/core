...
Vous retrouvez en haut à droite en cliquant sur le l'icône bonhomme puis profils
...
* *Authentification en 2 étapes* : permet de configurer l'authentification en 2 étape (pour rappel c'est un code changeant toute les XX secondes qui s'affiche sur une application mobile, type google authentificator)
