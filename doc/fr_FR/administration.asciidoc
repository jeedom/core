...
[IMPORTANT]
Si vous n'etes pas en mode expert certains paramètres peuvent ne pas etre visibles
...
* *Mode* : Mode de votre Jeedom maitre ou esclave, attention lors du passage en esclave : tous vos équipements, scénario, design... seront supprimés
...
Partie très importante dans Jeedom, il faut absolument la configurer correctement sinon beaucoup de plugin risquent d'etre non fonctionnels

* *Accès interne* : information pour joindre Jeedom à partir d'un équipement sur le meme réseau
