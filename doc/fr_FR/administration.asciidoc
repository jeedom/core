...
* <<couleurs,Couleurs>> : Les couleurs utilisés dans les interfaces de Jeedom.
...
* *Durée du bannissement (en secondes), -1 pour infini* : temps de banissement de l'IP
...
La liste des IP bannies se trouve au bas de cette page. Vous y trouverez l'IP, la date de bannissement et la date de fin de banissement programmée.
