...
-   **Clef API Pro** : utilisée pour communiquer avec le système de
    gestion de parc
...
-   **Accès à l’interface d’administration** : permet d’accèder à une
...
-   **Gestion avancée** : peut ne pas apparaitre en fonction de la
