...
- Ou en allant dans la page historique qui permet de superposer différentes courbes et de combiner les styles 
(aire, courbe, barre). Cette page permet aussi de supprimer tout l’historique d’une commande
