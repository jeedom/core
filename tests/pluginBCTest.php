...
class pluginBCTest extends TestCase
{
    ...
    {
        $file = fopen(__DIR__.'/list.txt', 'rb');
     ...
     */
    public function testRequiredFileExists(string $class): void
    {
     ...
     * @dataProvider getMethodsSignatures
     */
    public function testMethodExists(string $class, string $method): void
    {
     ...
     * @dataProvider getMethodsSignatures
     */
    public function testReturnType(string $class, string $method, string $expectedReturnType, bool $isFinal): void
    {
     ...
     * @dataProvider getMethodsSignatures
     */
    public function testFinal(string $class, string $method, $void, bool $expectedFinal): void
    {
        $reflectionMethod = new \ReflectionMethod($class, $method);
     ...
     * @dataProvider getMethodsSignatures
     */
    public function testAbstract(string $class, string $method, $void1, $void2, bool $expectedAbstract): void
    {
        $reflectionMethod = new \ReflectionMethod($class, $method);
     ...
     * @dataProvider getMethodsSignatures
     */
    public function testVisibility(string $class, string $method, $void1, $void2, $void3, bool $expectedPublic): void
    {
        $reflectionMethod = new \ReflectionMethod($class, $method);
     ...
     * @dataProvider getMethodsSignatures
     */
    public function testStatic(string $class, string $method, $void1, $void2, $void3, $void4, bool $expectedStatic): void
    {
        $reflectionMethod = new \ReflectionMethod($class, $method);
     ...
     * @dataProvider getMethodsSignatures
     */
    public function testParameters(string $class, string $method, $void1, $void2, $void3, $void4, $void5, array $expectedParameters): void
    {
        ...
        foreach ($arguments as $count => $argument) {
            ...
            $actualType = $actualTypeReflection === null ? '' : $actualTypeReflection->getName();
        ...
        foreach (glob(dirname(__DIR__) . '/core/class/*.php') as $file) {
            ...
            foreach ($reflection->getMethods() as $method) {
                ...
                foreach ($method->getParameters() as $parameter) {
                    ...
                    $a[] = $reflectionNamedType === null ? '' : $reflectionNamedType->getName();
                    $a[] = $parameter->getName();
                    $a[] = $parameter->isOptional();
                }
                file_put_contents(__DIR__.'/list.txt', implode(',', $a)."\n", $flag);
                $flag = FILE_APPEND;
            }
        }
    }
