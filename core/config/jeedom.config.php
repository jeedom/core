		...
		'widgets' => array(
			'action' => array(
				'other'=>array(
					...
					'garage' => array('template' => 'tmplicon',array('#_icon_on_#' => '<i class=\'icon jeedom-garage-ferme fa-2x\'></i>','#_icon_off_#' => '<i class=\'icon jeedom-garage-ouvert fa-stack-2x\'></i>')),
					...
					'timeGarage' => array('template' => 'tmpltimeIcon',array('#_icon_on_#' => '<i class=\'icon jeedom-garage-ferme fa-2x\'></i>','#_icon_off_#' => '<i class=\'icon jeedom-garage-ouvert fa-stack-2x\'></i>')),
					...
					'timeSprinkle' => array('template' => 'tmpltimeIcon','replace' => array('#_icon_on_#' => '<i class=\'icon nature-watering1\'></i>','#_icon_off_#' => '<i class=\'fas fa-times\'></i>')),
				),
				'slider'=>array(
					'light' => array('template' => 'tmplicon','replace' => array('#_icon_on_#' => '<i class=\'icon jeedom-lumiere-on\'></i>','#_icon_off_#' => '<i class=\'icon jeedom-lumiere-off\'></i>')),
				)
