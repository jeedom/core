...
$JEEDOM_INTERNAL_CONFIG = array(
	...
	'cmd' => array(
		'generic_type' => array(
			'LIGHT_STATE' => array('name' => 'Lumiere Etat (info)'),
			'LIGHT_ON' => array('name' => 'Lumiere Bouton ON'),
			'LIGHT_OFF' => array('name' => 'Lumiere Bouton OFF'),
			'LIGHT_SLIDER' => array('name' => 'Lumiere SLIDER'),
			'LIGHT_COLOR' => array('name' => 'Lumiere Couleur (info)'),
			'LIGHT_SET_COLOR' => array('name' => 'Lumiere Couleur (action)'),
			'ENERGY_STATE' => array('name' => 'Prise Etat (info)'),
			'ENERGY_ON' => array('name' => 'Prise Bouton ON'),
			'ENERGY_OFF' => array('name' => 'Prise Bouton OFF'),
			'ENERGY_SLIDER' => array('name' => 'Prise SLIDER'),
			'FLAP_STATE' => array('name' => 'Volet Etat (info)'),
			'FLAP_UP' => array('name' => 'Volet Bouton Monter'),
			'FLAP_DOWN' => array('name' => 'Volet Bouton Descendre'),
			'FLAP_STOP' => array('name' => 'Volet Bouton Stop'),
			'FLAP_SLIDER' => array('name' => 'Volet Bouton Slider'),
			'HEATING_ON' => array('name' => 'Chauffage fil pilote Bouton ON'),
			'HEATING_OFF' => array('name' => 'Chauffage fil pilote Bouton OFF'),
			'HEATING_STATE' => array('name' => 'Chauffage fil pilote Etat (info)'),
			'HEATING_OTHER' => array('name' => 'Chauffage fil pilote Bouton (action)'),
			'LOCK_STATE' => array('name' => 'Sérrure Etat (info)'),
			'LOCK_OPEN' => array('name' => 'Sérrure Bouton Ouvrir'),
			'LOCK_CLOSE' => array('name' => 'Sérrure Bouton Fermer'),
			'THERMOSTAT_STATE' => array('name' => 'Thermostat Etat (info)'),
			'THERMOSTAT_TEMPERATURE' => array('name' => 'Thermostat Temerature ambiante (info)'),
			...
			'THERMOSTAT_SET_LOCK' => array('name' => 'Thermostat Verouillage (action)'),
			'THERMOSTAT_LOCK' => array('name' => 'Thermostat Verouillage (info)'),
			'POWER' => array('name' => 'Information Puissance Electrique'),
			'CONSUMPTION' => array('name' => 'Information Consommation Electrique'),
			'TEMPERATURE' => array('name' => 'Information Température'),
			'BRIGHTNESS' => array('name' => 'Information Luminosité'),
			'PRESENCE' => array('name' => 'Information Présence'),
			'BATTERY' => array('name' => 'Information Batterie'),
			'SMOKE' => array('name' => 'Information détection de fumée'),
			'FLOOD' => array('name' => 'Information Inondation'),
			'HUMIDITY' => array('name' => 'Information humidité'),
			'UV' => array('name' => 'Information UV'),
			'OPENING' => array('name' => 'Information ouvrant'),
			'SABOTAGE' => array('name' => 'Information sabotage'),
			'CO2' => array('name' => 'Information CO2 (ppm)'),
			'VOLTAGE' => array('name' => 'Information Tension'),
			'NOISE' => array('name' => 'Information Son (dB)'),
			'PRESSURE' => array('name' => 'Information Pression'),
			'RAIN_CURRENT' => array('name' => 'Information Pluie (mm/h)'),
			'RAIN_TOTAL' => array('name' => 'Information Pluie (accumulation)'),
			'WIND_SPEED' => array('name' => 'Information Vent (vitesse)'),
			'WIND_DIRECTION' => array('name' => 'Information Vent (direction)'),
			'GENERIC' => array('name' => 'Information Generique'),
