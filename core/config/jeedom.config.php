...
$JEEDOM_INTERNAL_CONFIG = array(
	...
	'cmd' => array(
		'generic_type' => array(
			...
			'THERMOSTAT_STATE' => array('name' => 'Thermostat Etat (BINAIRE) (info)'),
			...
			'THERMOSTAT_SET_UNLOCK' => array('name' => 'Thermostat Dévéroullage (action)'),
			'THERMOSTAT_LOCK' => array('name' => 'Thermostat Verrouillage (info)'),
			'THERMOSTAT_TEMPERATURE_OUTDOOR' => array('name' => 'Thermostat Température Exterieur (info)'),
			'THERMOSTAT_STATE_NAME' => array('name' => 'Thermostat Etat (HUMAIN) (info)'),
			'CAMERA_UP' => array('name' => 'Mouvement caméra vers le haut (action)'),
			...
			'WEATHER_TEMPERATURE' => array('name' => 'Météo Température (info)'),
			'WEATHER_HUMIDITY' => array('name' => 'Météo Humidité (info)'),
			'WEATHER_PRESSURE' => array('name' => 'Météo Pression (info)'),
			'WEATHER_WIND_SPEED' => array('name' => 'Météo vitesse du vent (info)'),
			'WEATHER_WIND_DIRECTION' => array('name' => 'Météo direction du vent (info)'),
			'WEATHER_SUNSET' => array('name' => 'Météo lever de soleil (info)'),
			'WEATHER_SUNRISE' => array('name' => 'Météo coucher de soleil (info)'),
			'WEATHER_TEMPERATURE_MIN' => array('name' => 'Météo Température min (info)'),
			'WEATHER_TEMPERATURE_MAX' => array('name' => 'Météo Température max (info)'),
			'WEATHER_CONDITION' => array('name' => 'Météo condition (info)'),
			'WEATHER_CONDITION_ID' => array('name' => 'Météo condition (id) (info)'),
			'WEATHER_TEMPERATURE_MIN_1' => array('name' => 'Météo Température min j+1 (info)'),
			'WEATHER_TEMPERATURE_MAX_1' => array('name' => 'Météo Température max j+1 (info)'),
			'WEATHER_CONDITION_1' => array('name' => 'Météo condition j+1 (info)'),
			'WEATHER_CONDITION_ID_1' => array('name' => 'Météo condition (id) j+1 (info)'),
			'WEATHER_TEMPERATURE_MIN_2' => array('name' => 'Météo Température min j+2 (info)'),
			'WEATHER_TEMPERATURE_MAX_2' => array('name' => 'Météo condition j+1 max j+2 (info)'),
			'WEATHER_CONDITION_2' => array('name' => 'Météo condition j+2 (info)'),
			'WEATHER_CONDITION_ID_2' => array('name' => 'Météo condition (id) j+2 (info)'),
			'WEATHER_TEMPERATURE_MIN_3' => array('name' => 'Météo Température min j+3 (info)'),
			'WEATHER_TEMPERATURE_MAX_3' => array('name' => 'Météo Température max j+3 (info)'),
			'WEATHER_CONDITION_3' => array('name' => 'Météo condition j+3 (info)'),
			'WEATHER_CONDITION_ID_3' => array('name' => 'Météo condition (id) j+3 (info)'),
			'WEATHER_TEMPERATURE_MIN_4' => array('name' => 'Météo Température min j+4 (info)'),
			'WEATHER_TEMPERATURE_MAX_4' => array('name' => 'Météo Température max j+4 (info)'),
			'WEATHER_CONDITION_4' => array('name' => 'Météo condition j+4 (info)'),
			'WEATHER_CONDITION_ID_4' => array('name' => 'Météo condition (id) j+4 (info)'),
			...
			'OPENING' => array('name' => 'Porte (info)'),
			'OPENING_WINDOW' => array('name' => 'Fenêtre (info)'),
