...
$JEEDOM_INTERNAL_CONFIG = array(
	'object' => array(
		'summary' => array(
			...
			'outlet' => array('name' => 'Prise', 'calcul' => 'sum', 'iconOff' => '', 'iconOn' => 'icon jeedom-prise', 'unit' => '', 'count' => 'binary'),
	...
	'cmd' => array(
		'generic_type' => array(
			...
			'THERMOSTAT_STATE' => array('name' => 'Thermostat Etat (BINAIRE)', 'family' => 'Thermostat', 'type' => 'Info'),
			...
			'THERMOSTAT_SET_MODE' => array('name' => 'Thermostat Mode', 'family' => 'Thermostat', 'type' => 'Action'),
			'THERMOSTAT_MODE' => array('name' => 'Thermostat Mode', 'family' => 'Thermostat', 'type' => 'Info'),
			'THERMOSTAT_SET_LOCK' => array('name' => 'Thermostat Verrouillage', 'family' => 'Thermostat', 'type' => 'Action'),
			'THERMOSTAT_SET_UNLOCK' => array('name' => 'Thermostat Dévéroullage', 'family' => 'Thermostat', 'type' => 'Action'),
			'THERMOSTAT_LOCK' => array('name' => 'Thermostat Verrouillage', 'family' => 'Thermostat', 'type' => 'Info'),
			'THERMOSTAT_TEMPERATURE_OUTDOOR' => array('name' => 'Thermostat Température Exterieur', 'family' => 'Thermostat', 'type' => 'Info'),
			'THERMOSTAT_STATE_NAME' => array('name' => 'Thermostat Etat (HUMAIN)', 'family' => 'Thermostat', 'type' => 'Info'),
			...
			'ALARM_STATE' => array('name' => 'Alarme état', 'family' => 'Alarme', 'type' => 'Info'),
			'ALARM_MODE' => array('name' => 'Alarme mode', 'family' => 'Alarme', 'type' => 'Info'),
			'ALARM_ENABLE_STATE' => array('name' => 'Alarme état activée', 'family' => 'Alarme', 'type' => 'Info'),
			'ALARM_ARMED' => array('name' => 'Alarme armée', 'family' => 'Alarme', 'type' => 'Action'),
			'ALARM_RELEASED' => array('name' => 'Alarme libérée', 'family' => 'Alarme', 'type' => 'Action'),
			'ALARM_SET_MODE' => array('name' => 'Alarme Mode', 'family' => 'Alarme', 'type' => 'Action'),
			'WEATHER_TEMPERATURE' => array('name' => 'Météo Température', 'family' => 'Météo', 'type' => 'Info'),
			'WEATHER_HUMIDITY' => array('name' => 'Météo Humidité', 'family' => 'Météo', 'type' => 'Info'),
			'WEATHER_PRESSURE' => array('name' => 'Météo Pression', 'family' => 'Météo', 'type' => 'Info'),
			'WEATHER_WIND_SPEED' => array('name' => 'Météo vitesse du vent', 'family' => 'Météo', 'type' => 'Info'),
			'WEATHER_WIND_DIRECTION' => array('name' => 'Météo direction du vent', 'family' => 'Météo', 'type' => 'Info'),
			'WEATHER_SUNSET' => array('name' => 'Météo lever de soleil', 'family' => 'Météo', 'type' => 'Info'),
			'WEATHER_SUNRISE' => array('name' => 'Météo coucher de soleil', 'family' => 'Météo', 'type' => 'Info'),
			'WEATHER_TEMPERATURE_MIN' => array('name' => 'Météo Température min', 'family' => 'Météo', 'type' => 'Info'),
			'WEATHER_TEMPERATURE_MAX' => array('name' => 'Météo Température max', 'family' => 'Météo', 'type' => 'Info'),
			'WEATHER_CONDITION' => array('name' => 'Météo condition', 'family' => 'Météo', 'type' => 'Info'),
			'WEATHER_CONDITION_ID' => array('name' => 'Météo condition (id)', 'family' => 'Météo', 'type' => 'Info'),
			'WEATHER_TEMPERATURE_MIN_1' => array('name' => 'Météo Température min j+1', 'family' => 'Météo', 'type' => 'Info'),
			'WEATHER_TEMPERATURE_MAX_1' => array('name' => 'Météo Température max j+1', 'family' => 'Météo', 'type' => 'Info'),
			'WEATHER_CONDITION_1' => array('name' => 'Météo condition j+1', 'family' => 'Météo', 'type' => 'Info'),
			'WEATHER_CONDITION_ID_1' => array('name' => 'Météo condition (id) j+1', 'family' => 'Météo', 'type' => 'Info'),
			'WEATHER_TEMPERATURE_MIN_2' => array('name' => 'Météo Température min j+2', 'family' => 'Météo', 'type' => 'Info'),
			'WEATHER_TEMPERATURE_MAX_2' => array('name' => 'Météo condition j+1 max j+2', 'family' => 'Météo', 'type' => 'Info'),
			'WEATHER_CONDITION_2' => array('name' => 'Météo condition j+2', 'family' => 'Météo', 'type' => 'Info'),
			'WEATHER_CONDITION_ID_2' => array('name' => 'Météo condition (id) j+2', 'family' => 'Météo', 'type' => 'Info'),
			'WEATHER_TEMPERATURE_MIN_3' => array('name' => 'Météo Température min j+3', 'family' => 'Météo', 'type' => 'Info'),
			'WEATHER_TEMPERATURE_MAX_3' => array('name' => 'Météo Température max j+3', 'family' => 'Météo', 'type' => 'Info'),
			'WEATHER_CONDITION_3' => array('name' => 'Météo condition j+3', 'family' => 'Météo', 'type' => 'Info'),
			'WEATHER_CONDITION_ID_3' => array('name' => 'Météo condition (id) j+3', 'family' => 'Météo', 'type' => 'Info'),
			'WEATHER_TEMPERATURE_MIN_4' => array('name' => 'Météo Température min j+4', 'family' => 'Météo', 'type' => 'Info'),
			'WEATHER_TEMPERATURE_MAX_4' => array('name' => 'Météo Température max j+4', 'family' => 'Météo', 'type' => 'Info'),
			'WEATHER_CONDITION_4' => array('name' => 'Météo condition j+4', 'family' => 'Météo', 'type' => 'Info'),
			'WEATHER_CONDITION_ID_4' => array('name' => 'Météo condition (id) j+4', 'family' => 'Météo', 'type' => 'Info'),
