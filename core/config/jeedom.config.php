...
$JEEDOM_INTERNAL_CONFIG = array(
	...
	'cmd' => array(
		'generic_type' => array(
			...
			'LIGHT_ON' => array('name' => 'Lumiere Bouton ON (action)'),
			'LIGHT_OFF' => array('name' => 'Lumiere Bouton OFF (action)'),
			'LIGHT_SLIDER' => array('name' => 'Lumiere SLIDER (action)'),
			...
			'LOCK_OPEN' => array('name' => 'Sérrure Bouton Ouvrir (action)'),
			'LOCK_CLOSE' => array('name' => 'Sérrure Bouton Fermer (action)'),
			...
			'ALARM_STATE' => array('name' => 'Alarme etat (info)'),
			...
			'GENERIC' => array('name' => 'Generique (info)'),
