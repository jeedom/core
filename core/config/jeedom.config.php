		...
		'widgets' => array(
			'action' => array(
				'other'=>array(
					...
					'timeLight' => array('template' => 'tmpltimeIcon','replace' => array('#_icon_on_#' => '<i class=\'icon_light icon jeedom-lumiere-on\'></i>','#_icon_off_#' => '<i class=\'icon jeedom-lumiere-off\'></i>')),
					...
					'timeGarage' => array('template' => 'tmpltimeIcon',array('#_icon_on_#' => '<i class=\'icon_ok icon jeedom-garage-ferme fa-2x\'></i>','#_icon_off_#' => '<i class=\'icon_danger icon jeedom-garage-ouvert fa-stack-2x\'></i>')),
			...
			'info' => array(
				'binary'=>array(
					...
					'prise' => array('template' => 'tmplicon','replace' => array('#_icon_on_#' => '<i class=\'icon jeedom-prise\'></i>','#_icon_off_#' => '<i class=\'fas fa-times\'></i>')),
					'window' => array('template' => 'tmplicon','replace' => array('#_icon_on_#' => '<i class=\'icon_ok icon jeedom-fenetre-ferme\'></i>','#_icon_off_#' => '<i class=\'icon_danger icon jeedom-fenetre-ouverte\'></i>')),
					'timeDoor' => array('template' => 'tmpltimeIcon','replace' => array('#_icon_on_#' => '<i class=\'icon_ok icon jeedom-porte-ferme\'></i>','#_icon_off_#' => '<i class=\'icon_danger icon jeedom-porte-ouverte\'></i>')),
					'timePresence' => array('template' => 'tmpltimeIcon','replace' => array('#_icon_on_#' => '<i class=\'icon_ok fas fa-check\'></i>','#_icon_off_#' => '<i class=\'icon_danger icon jeedom-mouvement\'></i>')),
					'timeWindow' => array('template' => 'tmpltimeIcon','replace' => array('#_icon_on_#' => '<i class=\'icon_ok icon jeedom-fenetre-ferme\'></i>','#_icon_off_#' => '<i class=\'icon_danger icon jeedom-fenetre-ouverte\'></i>')),
				),
				'numeric'=>array(
