...
$JEEDOM_INTERNAL_CONFIG = array(
	...
	'generic_type' => array(
		...
		'FLAP_BSO_UP' => array('name' => __('Volet BSO Bouton Up',__FILE__), 'family' => __('Volet',__FILE__), 'type' => 'Action'),
		'FLAP_BSO_DOWN' => array('name' => __('Volet BSO Bouton Down',__FILE__), 'family' => __('Volet',__FILE__), 'type' => 'Action'),
