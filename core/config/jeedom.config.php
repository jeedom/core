...
$JEEDOM_INTERNAL_CONFIG = array(
	...
	'generic_type' => array(
		...
		'MEDIA_STATUS' => array('name' => __('Status Média',__FILE__), 'family' => __('Multimédia',__FILE__), 'type' => 'Info', 'noapp' => true),
		'MEDIA_ALBUM' => array('name' => __('Album Média',__FILE__), 'family' => __('Multimédia',__FILE__), 'type' => 'Info', 'noapp' => true),
		'MEDIA_ARTIST' => array('name' => __('Artiste Média',__FILE__), 'family' => __('Multimédia',__FILE__), 'type' => 'Info', 'noapp' => true),
		'MEDIA_TITLE' => array('name' => __('Titre Média',__FILE__), 'family' => __('Multimédia',__FILE__), 'type' => 'Info', 'noapp' => true),
