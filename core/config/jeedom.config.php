...
$JEEDOM_INTERNAL_CONFIG = array(
	...
	'generic_type' => array(
		...
		'LIGHT_ON' => array('name' => __('Lumière Bouton On',__FILE__), 'family' => __('Lumière',__FILE__), 'type' => 'Action','summary' => array('subtype' => 'other')),
		'LIGHT_OFF' => array('name' => __('Lumière Bouton Off',__FILE__), 'family' => __('Lumière',__FILE__), 'type' => 'Action','summary' => array('subtype' => 'other')),
		'LIGHT_SLIDER' => array('name' => __('Lumière Slider',__FILE__), 'family' => __('Lumière',__FILE__), 'type' => 'Action','summary' => array('subtype' => 'slider')),
		...
		'LIGHT_SET_COLOR' => array('name' => __('Lumière Couleur',__FILE__), 'family' => __('Lumière',__FILE__), 'type' => 'Action','summary' => array('subtype' => 'color')),
		...
		'ENERGY_ON' => array('name' => __('Prise Bouton On',__FILE__), 'family' => __('Prise',__FILE__), 'type' => 'Action','summary' => array('subtype' => 'other')),
		'ENERGY_OFF' => array('name' => __('Prise Bouton Off',__FILE__), 'family' => __('Prise',__FILE__), 'type' => 'Action','summary' => array('subtype' => 'other')),
		...
		'FLAP_UP' => array('name' => __('Volet Bouton Monter',__FILE__), 'family' => __('Volet',__FILE__), 'type' => 'Action','summary' => array('subtype' => 'other')),
		'FLAP_DOWN' => array('name' => __('Volet Bouton Descendre',__FILE__), 'family' => __('Volet',__FILE__), 'type' => 'Action','summary' => array('subtype' => 'other')),
		...
		'FLAP_BSO_UP' => array('name' => __('Volet BSO Bouton Monter',__FILE__), 'family' => __('Volet',__FILE__), 'type' => 'Action','summary' => array('subtype' => 'other')),
		'FLAP_BSO_DOWN' => array('name' => __('Volet BSO Bouton Descendre',__FILE__), 'family' => __('Volet',__FILE__), 'type' => 'Action','summary' => array('subtype' => 'other')),
		'HEATING_ON' => array('name' => __('Chauffage fil pilote Bouton ON',__FILE__), 'family' => __('Chauffage',__FILE__), 'type' => 'Action','summary' => array('subtype' => 'other')),
		'HEATING_OFF' => array('name' => __('Chauffage fil pilote Bouton OFF',__FILE__), 'family' => __('Chauffage',__FILE__), 'type' => 'Action','summary' => array('subtype' => 'other')),
		...
		'LOCK_OPEN' => array('name' => __('Serrure Bouton Ouvrir',__FILE__), 'family' => __('Ouvrant',__FILE__), 'type' => 'Action','summary' => array('subtype' => 'other')),
		'LOCK_CLOSE' => array('name' => __('Serrure Bouton Fermer',__FILE__), 'family' => __('Ouvrant',__FILE__), 'type' => 'Action','summary' => array('subtype' => 'other')),
		'SIREN_STATE' => array('name' => __('Sirène Etat',__FILE__), 'family' => __('Sécurité',__FILE__), 'type' => 'Info'),
		'SIREN_OFF' => array('name' => __('Sirène Bouton Off',__FILE__), 'family' => __('Sécurité',__FILE__), 'type' => 'Action','summary' => array('subtype' => 'other')),
		'SIREN_ON' => array('name' => __('Sirène Bouton On',__FILE__), 'family' => __('Sécurité',__FILE__), 'type' => 'Action','summary' => array('subtype' => 'other')),
		...
		'GB_OPEN' => array('name' => __('Portail ou garage bouton d\'ouverture',__FILE__), 'family' => __('Ouvrant',__FILE__), 'type' => 'Action','summary' => array('subtype' => 'other')),
		'GB_CLOSE' => array('name' => __('Portail ou garage bouton de fermeture',__FILE__), 'family' => __('Ouvrant',__FILE__), 'type' => 'Action','summary' => array('subtype' => 'other')),
