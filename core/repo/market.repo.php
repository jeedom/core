...
class repo_market {
	...
	public static function postJsonRpc(&$_result) {
		...
		if (is_array($_result)) {
			...
			if (config::byKey('market::allowDNS') == 1 && isset($_result['service::tunnel::hostl']) && config::byKey('jeedom::url') != $_result['service::tunnel::host']) {
				config::save('jeedom::url', $_result['service::tunnel::host']);
			}
