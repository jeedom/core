...
class config {
	...
	public static function save($_key, $_value, $_plugin = 'core') {
        ConfigurationFactory::build($_plugin)->set($_key, $_value);
	...
	public static function remove($_key, $_plugin = 'core') {
        ConfigurationFactory::build($_plugin)->remove($_key);
	}
	...
	public static function byKey($_key, $_plugin = 'core', $_default = '', $_forceFresh = false) {
        return ConfigurationFactory::build($_plugin)->get($_key, $_default);
	}

	public static function byKeys($_keys, $_plugin = 'core', $_default = '') {
        return ConfigurationFactory::build($_plugin)->multiGet($_keys, $_default);
	}

	public static function searchKey($_key, $_plugin = 'core') {
        return ConfigurationFactory::build($_plugin)->search($_key);
	}
