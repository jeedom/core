...
class history
{
     ...
     * @return string
     */
    public static function exportToCSV($histories): string
    {
     ...
     */
    public static function byCmdIdDatetime($_cmd_id, $_startTime, $_endTime = null, $_oldValue = null): ?array
    {
        if ($_endTime == null) {
            $_endTime = $_startTime;
        }
     ...
     * @throws ReflectionException
     */
    public static function getOldestValue($_cmd_id): array
    {
        $values = array(
            'cmd_id' => $_cmd_id,
        );
     ...
     * @throws Exception
     */
    public static function removes($_cmd_id, $_startTime = null, $_endTime = null): bool
    {
        $values = array(
            'cmd_id' => $_cmd_id,
        );
     ...
     * @throws ReflectionException
     */
    public static function getPlurality($_cmd_id, $_startTime = null, $_endTime = null, $_period = 'day', $_offset = 0): ?array
    {
        $values = array(
            'cmd_id' => $_cmd_id,
        );
     ...
     * @throws ReflectionException
     **/
    public static function all($_cmd_id, $_startTime = null, $_endTime = null, $_groupingType = null): array
    {
        $values = array(
            'cmd_id' => $_cmd_id,
        );
     ...
     * @throws Exception
     */
    public static function getStatistique($_cmd_id, $_startTime, $_endTime): array
    {
        $values = array(
            'cmd_id' => $_cmd_id,
            'startTime' => $_startTime,
     ...
     * @throws Exception
     */
    public static function stateChanges($_cmd_id, $_value = null, $_startTime = null, $_endTime = null): array
    {
        $cmd = cmd::byId($_cmd_id);
        if (!is_object($cmd)) {
            throw new Exception(__('Commande introuvable : ', __FILE__) . $_cmd_id);
     ...
     * @param null $_dateEnd
     * @param false $_noCalcul
     * @param null $_groupingType
     * @return array
     * @throws Exception
     */
    public static function getHistoryFromCalcul($_strcalcul, $_dateStart = null, $_dateEnd = null, $_noCalcul = false, $_groupingType = null): array
    {
        $now = strtotime('now');
        $value = array();
        $cmd_histories = array();
     ...
     * @throws Exception
     */
    public static function emptyHistory($_cmd_id, $_date = ''): ?array
    {
        $values = array(
            'cmd_id' => $_cmd_id,
        );
     ...
     * @return $this
     */
    public function setCmd_id($_cmd_id): history
    {
     ...
     * @return $this
     */
    public function setDatetime($_datetime): history
    {
     ...
     * @return $this
     */
    public function setValue($_value): history
    {
     ...
     * @return $this
     */
    public function setTableName($_tableName): history
    {
     ...
     * @return $this
     */
    public function setChanged($_changed): history
    {
