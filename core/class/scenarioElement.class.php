...
class scenarioElement
{
     ...
     * @throws ReflectionException
     */
    public function getSubElement($_type = ''): ?array
    {
        if ($_type != '') {
     ...
     * @throws ReflectionException
     */
    public function getAjaxElement($_mode = 'ajax'): array
    {
     ...
     * @return $this
     */
    public function setId($_id): scenarioElement
    {
     ...
     * @return $this
     */
    public function setName($_name): scenarioElement
    {
     ...
     * @return $this
     */
    public function setType($_type): scenarioElement
    {
     ...
     * @return $this
     */
    public function setOptions($_key, $_value): scenarioElement
    {
     ...
     * @return $this
     */
    public function setOrder($_order): scenarioElement
    {
     ...
     * @return $this
     */
    public function setChanged($_changed): scenarioElement
    {
