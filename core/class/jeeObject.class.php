		...
		if ($_tag) {
			if ($_prettify) {
				if ($this->getDisplay('tagColor') != '') {
					return '<span class="label objectHumanName" style="text-shadow : none;background-color:' . $this->getDisplay('tagColor') . ' !important;color:' . $this->getDisplay('tagTextColor', 'white') . ' !important"  data-id="' . $this->getId() . '">' . $this->getDisplay('icon') . ' ' . $this->getName() . '</span>';
				} else {
					return '<span class="label label-primary objectHumanName" style="text-shadow : none;"  data-id="' . $this->getId() . '">' . $this->getDisplay('icon') . ' ' . $this->getName() . '</span>';
				}
			} else {
				return '<span class="objectHumanName" data-id="' . $this->getId() . '">' . $this->getDisplay('icon') . ' ' . $this->getName() . '</span>';
			}
		} else {
			return $this->getName();
		}
