...
class jeedom {
	...
	public static function health() {
		...
		if (cache::isPersistOk()) {
			...
			$cache_health['comment'] = __('Votre cache n\'est pas sauvegardé en cas de redemarrage certaines informations peuvent être perdues. Essayez de lancer (à partir du moteur de tâche) la tâche cache::persist', __FILE__);
			$state = network::test('external');
		}
		$return[] = $cache_health;
