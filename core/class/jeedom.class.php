...
class jeedom
{
     ...
     * @throws Exception
     */
    public static function getApiKey($_plugin = 'core'): string
    {
        if ($_plugin == 'apipro') {
     ...
     * @throws Exception
     */
    public static function apiModeResult($_mode = 'enable'): bool
    {
        switch ($_mode) {
            case 'disable':
                return false;
     ...
     * @throws Exception
     */
    public static function apiAccess($_apikey = '', $_plugin = 'core'): bool
    {
        if (trim($_apikey) == '') {
            return false;
        }
     ...
     * @return string|null
     */
    public static function checkOngoingThread($_cmd): ?string
    {
     ...
     * @return string|null
     */
    public static function retrievePidThread($_cmd): ?string
    {
    ...
    /**
     * @param $_version
     * @param bool $_lightMode
     * @return string
     */
    public static function versionAlias($_version, $_lightMode = true): string
    {
        if ($_version == 'mview') {
            return 'mobile';
        }
     ...
     * @throws ReflectionException
     */
    public static function getTypeUse($_string = ''): array
    {
     ...
     * @return array
     */
    public static function getRemovehistory(): array
    {
        if (file_exists(__DIR__ . '/../../data/remove_history.json')) {
            $remove_history = json_decode(file_get_contents(__DIR__ . '/../../data/remove_history.json'), true);
        }
    ...
    public static function rebootSystem()
    {
        ...
        cache::persist();
        if (self::isCapable('sudo')) {
            exec(system::getCmdSudo() . 'reboot -f now');
        } else {
     ...
     * @return float
     */
    public static function checkSpaceLeft($_dir = null): float
    {
        if ($_dir == null) {
            $path = __DIR__ . '/../../';
        } else {
     ...
     * @throws Exception
     */
    public static function getTmpFolder($_plugin = null): string
    {
     ...
     * @throws Exception
     */
    public static function getHardwareName(): string
    {
    ...
    /**
     * @param $_function
     * @param false $_forceRefresh
     * @return bool
     * @throws Exception
     */
    public static function isCapable($_function, $_forceRefresh = false): bool
    {
