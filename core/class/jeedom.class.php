	...
	public static function isDateOk() {
		if (config::byKey('ignoreHourCheck') == 1) {
			return true;
                ...
                $maxDateValue = (new \DateTime('now'))->modify('+5 year')->format('Y-m-d 00:00:00');
		$maxdate = strtotime($maxDateValue);
                $minDateValue = (new \DateTime('now'))->modify('-1 year')->format('Y-m-d 00:00:00');
		$mindate = strtotime( $minDateValue);
